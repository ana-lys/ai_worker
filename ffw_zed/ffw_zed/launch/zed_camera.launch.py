...
default_config_common = os.path.join(
    get_package_share_directory('ffw_zed'),
    'config',
    'common'
)
...
def launch_setup(context, *args, **kwargs):
    ...
    wrapper_dir = get_package_share_directory('ffw_zed')    
    ...
    load_composable_node = LoadComposableNodes(
        ...
        composable_node_descriptions=[ffw_zed_component]
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description='The name of the ffw_zed node. All the topic will have the same prefix: `/<camera_name>/<node_name>/`. If a namespace is specified, the node name is replaced by the camera name.'),
            DeclareLaunchArgument(
