...
#
# Debug variant of SMTM with right gripper removed:
#   - Left arm keeps RH-P12-RN-A gripper (ID 38)
#   - Right arm has NO gripper (XM430 and joints removed), 7 arm joints only
#   - Total: 21 joints
#   - Uses ffw_sg2_smtm_debug URDF/ros2_control tree
#
...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            'init_position_file',
            default_value='ffw_sg2_smtm_debug_initial_positions.yaml',
            description='Initial position file.'),
        DeclareLaunchArgument(
            'ros2_control_type',
            default_value='ffw_sg2_smtm_debug',
    ...
    controller_manager_config = PathJoinSubstitution([
        ...
        'ffw_sg2_smtm_debug_ai_hardware_controller.yaml'
    ])
