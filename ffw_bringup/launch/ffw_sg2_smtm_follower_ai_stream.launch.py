...
#
# Modified for FFW_SG2SMTM variant:
#   - Replaces RH-P12-RN-A gripper with XM430-W350 on the RIGHT arm only
#   - Left arm keeps RH-P12-RN-A gripper (ID 38, unchanged)
#   - Total: 22 joints
...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            'init_position_file',
            default_value='ffw_sg2_smtm_initial_positions.yaml',
            description='Initial position file.'),
        DeclareLaunchArgument(
            'ros2_control_type',
            default_value='ffw_sg2_smtm',
    ...
    controller_manager_config = PathJoinSubstitution([
        ...
        'ffw_sg2_smtm_ai_hardware_controller.yaml'
    ])
