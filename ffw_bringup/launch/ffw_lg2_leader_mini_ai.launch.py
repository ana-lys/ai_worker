...
def generate_launch_description():
    declared_arguments = [
        DeclareLaunchArgument(
            'description_file',
            default_value='ffw_lg2_leader_mini.urdf.xacro',
    ...
    robot_controllers = PathJoinSubstitution(
        [
            ...
            'config',
            'ffw_lg2_leader_mini',
            'ffw_lg2_leader_mini_ai_hardware_controller.yaml',
        ]
    )
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare('ffw_description'), 'urdf', 'ffw_lg2_leader_mini', description_file]
            ),
        ]
    )
