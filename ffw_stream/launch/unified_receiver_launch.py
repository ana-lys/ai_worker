...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('oakd_codec', default_value='mjpeg',
                              description='OAK-D codec: mjpeg (default, zero-latency) or h264 (fallback)'),
        DeclareLaunchArgument('rs_codec', default_value='mjpeg',
                              description='RealSense D405/D435 codec: mjpeg (default, zero-latency) or h264'),
